...
is 'instirepo' but you can feel free to change it.  Right now the
...
`wsgi/instirepo/db.sqlite3` with your newly changed login
...
Use `rhc ssh` to log into python gear and run this command:
	...
	python $OPENSHIFT_REPO_DIR/wsgi/instirepo/manage.py createsuperuser
