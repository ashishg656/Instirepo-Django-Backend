...
admin.site.register(FollowingPosts)
admin.site.register(UserProfileImagesHeader)
admin.site.register(DropboxFilesForPosts)
admin.site.register(ResumesDropbox)
